export const selfDiagnosis = [
    ...
    content: `<div class="text-gray-900 space-y-4 text-base leading-relaxed">
      ...
      <div class="bg-blue-50 p-4 rounded-lg">
        ...
        <ul class="space-y-2 text-blue-700">
          ...
          <li>• Evil thoughts and whisperings about Allah or Islam</li>
          <li>• Inappropriate sexual or blasphemous thoughts</li>
          <li>• Sudden anxiety, fear, or panic during ruqyah</li>
          <li>• Yawning, burping, or crying when reading Qur'an</li>
          <li>• Nausea or vomiting during/after ruqyah</li>
          <li>• Twitching, jerking, or unusual body movements</li>
          <li>• A sense of "something inside you" resisting</li>
        </ul>
      </div>
  ...
  },
  {
    ...
    content: `<div class="text-gray-900 space-y-6 text-base leading-relaxed">
      ...
      <div class="space-y-6">
        <div>
          <h4 class="font-bold text-gray-800 mb-3 text-lg">1. Safe Self-Testing Options</h4>
          
          <div class="space-y-4">
            <div class="bg-green-50 p-4 rounded-lg">
              <h5 class="font-bold text-green-800 mb-2">Option A: Recitation Test</h5>
            ...
            <div class="bg-blue-50 p-4 rounded-lg">
              <h5 class="font-bold text-blue-800 mb-2">Option B: Listening Test</h5>
              <div class="text-blue-700 space-y-2">
            ...
            <div class="bg-orange-50 p-4 rounded-lg">
              <h5 class="font-bold text-orange-800 mb-2">Option D: Oil Application Test</h5>
            ...
            <div class="bg-teal-50 p-4 rounded-lg">
              <h5 class="font-bold text-teal-800 mb-2">Option E: Dream Observation Test</h5>
              <div class="text-teal-700 space-y-2">
        ...
        <div>
          ...
          <div class="bg-gray-50 p-4 rounded-lg mt-4">
            <p class="text-gray-600 italic">For a detailed explanation of the different types of sihr and how they are carried out, see the "Sihr/Magic" section of this app.</p>
          </div>
        </div>
      </div>
    </div>`
