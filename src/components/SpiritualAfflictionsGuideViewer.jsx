...
const SpiritualAfflictionsGuideViewer = ({ onBack, isDarkMode }) => {
  useEffect(() => {
    // Load the HTML file content into an iframe
    const iframe = document.getElementById('spiritual-afflictions-iframe')
    if (iframe) {
      iframe.src = '/spiritualAfflictionsGuide.html'
    }
  }, [])
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <div className="w-full h-full">
        <iframe
          id="spiritual-afflictions-iframe"
...
export default SpiritualAfflictionsGuideViewer