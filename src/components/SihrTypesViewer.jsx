...
const SihrTypesViewer = ({ onBack, isDarkMode }) => {
  useEffect(() => {
    // Load the HTML file content into an iframe
    const iframe = document.getElementById('sihr-types-iframe')
    if (iframe) {
      iframe.src = '/sihrTypes.html'
    }
  }, [])
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <div className="w-full h-full">
        <iframe
          id="sihr-types-iframe"
          title="Types of Sihr Guide"
...
export default SihrTypesViewer