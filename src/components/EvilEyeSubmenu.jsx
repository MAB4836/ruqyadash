...
const EvilEyeSubmenu = ({ onSelectOption, onBack }) => {
  const submenuOptions = [
    {
      id: 'understandingEvilEye',
      title: 'Understanding the Evil Eye',
      description: 'Learn what al-\'ayn is, evidence, and signs of being affected'
    },
    {
      id: 'quranicProtection',
      title: 'Quranic Verses of Protection',
      description: 'Powerful Quranic verses and surahs for protection from evil eye'
    },
    {
      id: 'propheticDuas',
      title: 'Prophetic Duas for Protection',
      description: 'Authentic du\'as taught by Prophet ﷺ for protection'
    },
    {
      id: 'dailyProtectionRoutine',
      title: 'Daily Protection Routine',
      description: 'Sunnah-based daily practices for ongoing protection'
    },
    {
      id: 'performingRuqyah',
      title: 'Performing Ruqyah',
      description: 'Step-by-step guide for performing ruqyah against evil eye'
    },
    {
      id: 'preventingEvilEye',
      title: 'Preventing Causing Evil Eye',
      description: 'How to avoid giving evil eye to others'
    }
  ]
